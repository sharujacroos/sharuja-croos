      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">Uva Wellassa University of Sri Lanka</h4>
            <p>
            I am currently an undergraduate in Computer Science and Technology Degree Programme
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
